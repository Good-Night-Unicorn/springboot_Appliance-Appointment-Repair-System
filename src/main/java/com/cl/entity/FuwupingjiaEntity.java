...
public class FuwupingjiaEntity<T> implements Serializable {
	...
	private Integer weixiupingjia;
	
	/**
	 * 师傅评价
	 */
					
	private Integer shifupingjia;
	 ...
	 * 设置：维修评价
	 */
	public void setWeixiupingjia(Integer weixiupingjia) {
		this.weixiupingjia = weixiupingjia;
	}
	/**
	 * 获取：维修评价
	 */
	public Integer getWeixiupingjia() {
		return weixiupingjia;
	}
	/**
	 * 设置：师傅评价
	 */
	public void setShifupingjia(Integer shifupingjia) {
		this.shifupingjia = shifupingjia;
	}
	/**
	 * 获取：师傅评价
	 */
	public Integer getShifupingjia() {
		return shifupingjia;
	}
	/**
	 * 设置：维修金额
	 */
	public void setWeixiujine(String weixiujine) {
