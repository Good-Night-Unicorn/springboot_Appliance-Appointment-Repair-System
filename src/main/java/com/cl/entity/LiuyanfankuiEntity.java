...
public class LiuyanfankuiEntity<T> implements Serializable {
	 ...
	 * 设置：反馈对象
	 */
	public void setFankuiduixiang(String fankuiduixiang) {
		this.fankuiduixiang = fankuiduixiang;
	}
	/**
	 * 获取：反馈对象
	 */
	public String getFankuiduixiang() {
		return fankuiduixiang;
	}
	/**
	 * 设置：用户
	 */
