...
import com.cl.service.FuwupingjiaService;
...
public class FuwupingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,FuwupingjiaEntity fuwupingjia,
                    ...
                    fuwupingjia.setYonghu((String)request.getSession().getAttribute("username"));
                                    }
                                                                                                            if(tableName.equals("weixiugong")) {
                    fuwupingjia.setGonghao((String)request.getSession().getAttribute("username"));
                                    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		fuwupingjia = fuwupingjiaService.selectView(new EntityWrapper<FuwupingjiaEntity>().eq("id", id));
